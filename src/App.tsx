...
export default function App() {
  ...
  const page = useMemo(() => {
    switch (route) {
      ...
      default: return <ChatsPage conversations={nexus.conversations} messages={nexus.messages} onSend={nexus.sendMessage} onPair={nexus.addContact} identity={nexus.identity} />;
    }
  }, [nexus, route]);

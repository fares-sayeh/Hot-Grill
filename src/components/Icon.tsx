...
export function Icon({ name, size = 20 }: { name: string; size?: number }) {
  const paths: Record<string, ReactNode> = {
    ...
    qr: <><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M15 15h2v2h-2zM19 15h2M15 19h2v2M19 19h2v2"/></>,
    phone: <path d="M7 3h3l1 5-2 1a15 15 0 0 0 6 6l1-2 5 1v3c0 1.1-.9 2-2 2C11 19 5 13 5 5c0-1.1.9-2 2-2Z"/>,

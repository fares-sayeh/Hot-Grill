...
export function Icon({ name, size = 20 }: IconProps) {
  const paths: Record<string, ReactNode> = {
    chat: (
      <>
        <path d="M20 15a4 4 0 0 1-4 4H9l-5 3v-3a4 4 0 0 1-2-3.5V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z" />
    ...
    paperclip: (
      <path d="m20 11-8.7 8.7a5 5 0 0 1-7.1-7.1L13 3.8a3.5 3.5 0 0 1 5 5l-8.3 8.3a2 2 0 0 1-2.8-2.8l7.6-7.6" />
    ),
    ...
    shield: (
      <>
        <path d="M12 3 5 6v5c0 4.8 3 8 7 10 4-2 7-5.2 7-10V6l-7-3Z" />
